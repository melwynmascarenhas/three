...
const planeMaterial = new THREE.MeshBasicMaterial({ color: 0xFFFFFF, side: THREE.DoubleSide }); //material on both inner and outer surface
...
const spherMaterial = new THREE.MeshBasicMaterial({ color: 0x0000ff, wireframe: false })
